...
def test_id_cycle(times=20):
    ...
    ID_1 = "tw.com.icash.a.icashpay.debuging:id/scan"  # 點擊_1 的 ID
    ID_2 = "tw.com.icash.a.icashpay.debuging:id/txt_right"    # 點擊_2 的 ID
    ID_3 = "com.android.permissioncontroller:id/permission_allow_foreground_only_button"                # 點擊_3 (通常是系統彈窗)
    ID_4 = "tw.com.icash.a.icashpay.debuging:id/toolbarRightImage"     # 點擊_4 的 ID
