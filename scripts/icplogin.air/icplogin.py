...
sleep(1.0)
poco("android.widget.FrameLayout").child("android.widget.LinearLayout").offspring("tw.com.icash.a.icashpay.debuging:id/base_container").offspring("tw.com.icash.a.icashpay.debuging:id/nav").offspring("android.widget.ImageView").click()
poco("android.widget.FrameLayout").child("android.widget.LinearLayout").offspring("tw.com.icash.a.icashpay.debuging:id/frameLayout").child("android.widget.LinearLayout").offspring("tw.com.icash.a.icashpay.debuging:id/lock_view").child("android.view.View")[2].swipe([-0.524, 0.2234])
poco("tw.com.icash.a.icashpay.debuging:id/close").click()
poco("android.widget.FrameLayout").child("android.widget.LinearLayout").offspring("tw.com.icash.a.icashpay.debuging:id/base_container").offspring("tw.com.icash.a.icashpay.debuging:id/fragment_container").offspring("tw.com.icash.a.icashpay.debuging:id/scroll_view").offspring("tw.com.icash.a.icashpay.debuging:id/home_container").child("android.widget.LinearLayout").child("android.widget.LinearLayout").offspring("tw.com.icash.a.icashpay.debuging:id/function_wallet").child("android.view.ViewGroup").offspring("tw.com.icash.a.icashpay.debuging:id/transfer").child("android.widget.ImageView").click()
